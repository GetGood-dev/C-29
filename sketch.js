...
function setup()
{
    ...
    box8 = new box(360,210,20,30);
    box9 = new box(380,210,20,30);
    box10 = new box(400,210,20,30);
    box11 = new box(420,210,20,30);
    box12 = new box(440,210,20,30);

    box13 = new box(380,170,20,30);
    box14 = new box(400,170,20,30);
    box15 = new box(420,170,20,30);

    box16 = new box(400,140,20,30);
}
